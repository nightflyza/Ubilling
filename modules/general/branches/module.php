...
$this->registerModule($module, 'main', __('Branches'), 'Nightfly', array('BRANCHES' => __('right to use branches module'),
    ...
    'BRANCHESUSERMOD' => __('right to switch existing user branches')
));
?>
