...
if (cfr('PHONEBOOK')) {
    ...
    class PhoneBook {
        ...
        public function createContact($phone, $name) {
            $phoneF = loginDB_real_escape_string($phone);
        ...
        public function saveContact() {
            if (wf_CheckPost(array('editcontactphone', 'editcontactname', 'editcontactid'))) {
                ...
                if (isset($this->allContacts[$contactId])) {
                    $newPhone = loginDB_real_escape_string($_POST['editcontactphone']);
                    $newName = loginDB_real_escape_string($_POST['editcontactname']);
