                ...
                if (empty($foundId)) {
                    if (ubRouting::checkGet('fmpquickadd')) {
                        $Banksta->addFieldsMappingPreset($newFMPName,
                                                         ...
                                                         ubRouting::post('bsinetkeywords'), (ubRouting::checkPost('bsinetkeywordsnoesc') ? 1 : 0),
                                                         ubRouting::post('bsukvdelimstart', 'mres'), ubRouting::post('bsukvdelimend', 'mres'),
                                                         ubRouting::post('bsukvkeywords'), (ubRouting::checkPost('bsukvkeywordsnoesc') ? 1 : 0),
                                                         (ubRouting::checkPost('bsskiprow') ? 1 : 0),
                                                         ubRouting::post('bsskiprow_col', 'int'), ubRouting::post('bsskiprowkeywords'),
                                                         (ubRouting::checkPost('bsskiprowkeywordsnoesc') ? 1 : 0),
                                                         (ubRouting::checkPost('bsreplacestrs') ? 1 : 0),
                                                         ubRouting::post('bscolsreplacestrs'), ubRouting::post('bsstrstoreplace'),
                                                         ...
                                                         ubRouting::post('bscolremovestrs'), ubRouting::post('bsstrstoremove'),
                        ...
                        $Banksta->addFieldsMappingPreset($newFMPName,
                                                         ...
                                                         ubRouting::post('fmpinetkeywords'), (ubRouting::checkPost('fmpinetkeywordsnoesc') ? 1 : 0),
                                                         ubRouting::post('fmpukvdelimstart', 'mres'), ubRouting::post('fmpukvdelimend', 'mres'),
                                                         ubRouting::post('fmpukvkeywords'), (ubRouting::checkPost('fmpukvkeywordsnoesc') ? 1 : 0),
                                                         (ubRouting::checkPost('fmpskiprow') ? 1 : 0),
                                                         ubRouting::post('fmpcolskiprow', 'int'), ubRouting::post('fmpskiprowkeywords'),
                                                         (ubRouting::checkPost('fmpskiprokeywordsnoesc') ? 1 : 0),
                                                         (ubRouting::checkPost('fmpreplacestrs') ? 1 : 0),
                                                         ubRouting::post('fmpcolsreplacestrs', 'int'), ubRouting::post('fmpstrstoreplace'),
                                                         ...
                                                         ubRouting::post('fmpcolsremovestrs', 'int'), ubRouting::post('fmpstrstoremove'),
                                                         (ubRouting::checkPost('fmpremovekeywordsnoesc') ? 1 : 0),
                                                         ubRouting::post('fmppaymtypeid'), ubRouting::post('fmpcolsrvidents', 'int'),
