...
if (cfr('NAS')) {
    ...
    if (!wf_CheckGet(array('edit'))) {
        ...
        if (wf_CheckPost(array('editnastype'))) {
            ...
            $nasip = loginDB_real_escape_string($_POST['editnasip']);
            $nasname = loginDB_real_escape_string($_POST['editnasname']);
            $nasbwdurl = loginDB_real_escape_string($_POST['editnasbwdurl']);
