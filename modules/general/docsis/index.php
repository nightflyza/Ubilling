...
if ($altercfg['DOCSIS_SUPPORT']) {
  ...
  function docsis_ModemAdd($maclan) {
       $maclan=  loginDB_real_escape_string($maclan);
       //random mac for usb
...
//editing modem
  if ( (isset($_POST['edituserbind'])) AND (isset($_POST['editnote'])) ) {
      ...
      $newmodemuserbind=  loginDB_real_escape_string($_POST['edituserbind']);
      $newmodemnote=      loginDB_real_escape_string($_POST['editnote']);
