        ...
        fillRGBFields = function(hsx, cal) {
            ...
            $(cal).data('colpick').fields
                ...
                clickSubmit = function(ev) {
                    ...
                    cal.data('colpick').onSubmit(col, cal.data('colpick').hsl ? hslToHex(col) : hslToHex(col), cal.data('colpick').hsl ? hslToRgb(col) : hsbToRgb(col), cal.data('colpick').el);
                },
