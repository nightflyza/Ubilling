...
function animationStart() {
    document.getElementById("sphinxsearchinput").className = "sphinxsearch-input-loading form-control globalsearchinput";
}

function animationStop() {
    document.getElementById("sphinxsearchinput").className = "sphinxsearch-input form-control globalsearchinput";
}
