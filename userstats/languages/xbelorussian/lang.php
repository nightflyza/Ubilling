...
$lang['def'][' and '] = ' і ';
$lang['def']['days of month'] = 'лікамі месяцы';
...
$lang['def']['Take me credit please'] = 'Пусціце мяне ў крэдыт калі ласка';
...
$lang['def']['You current tariff is'] = 'Ваш бягучы тарыф';
...
$lang['def']['Payment cards not enabled at this moment'] = 'Картачныя плацяжы зараз адключаныя';
...
$lang['def']['Unfortunately online payments is disabled'] = 'На жаль інтэграцыя з OpenPayz зараз адключаная';
$lang['def']['No available payment systems'] = 'Аплатныя сістэмы не вызначаны';

$lang['def']['Ticketing'] = 'Дапамога';
