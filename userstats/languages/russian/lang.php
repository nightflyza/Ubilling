...
$lang['def']['before the credit expire date'] = 'до даты истечения кредита';
$lang['def']['before inactiveness penalty will be applied'] = 'до начисления штрафа за неактивность';
$lang['def']['before available freeze days run out'] = 'до исчерпания доступных дней заморозки';
...
$lang['def']['You can activate your new devices by logging on oll.tv with mobile'] = 'Вы можете активировать ваши новые устройства авторизовавшись на oll.tv при помощи мобильного';
$lang['def']['and code'] = 'и кода';
$lang['def']['Nothing to show'] = 'Нечего показывать';
$lang['def']['Serial'] = 'Серийник';
$lang['def']['You have no mobile number filled in your profile. Please contact your ISP.'] = 'В вашем профиле не заполнен основной номер мобильного. Свяжитесь с вашим провайдером по этому поводу.';
$lang['def']['Yes'] = 'Да';
$lang['def']['No'] = 'Нет';
...
$lang['def']['Congratulations! You have successfully used a promo code'] = 'Поздравляем! Вы успешно использовали промокод';
$lang['def']['The funds are already in your account'] = 'Средства уже на вашем счету';
$lang['def']['The funds are already on the way and will be on your account in a minute or two'] = 'Средства уже в пути. Они будут на вашем счету через минуту либо две';
$lang['def']['Good'] = 'Хорошо';
$lang['def']['I see'] = 'Понятно';