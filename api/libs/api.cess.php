...
function zb_ContrAhentAdd($bankacc, $bankname, $bankcode, $edrpo, $ipn, $licensenum, $juraddr, $phisaddr, $phone, $contrname) {
    $bankacc = DB_real_escape_string($bankacc);
    $bankname = DB_real_escape_string($bankname);
    $bankcode = DB_real_escape_string($bankcode);
    $edrpo = DB_real_escape_string($edrpo);
    $ipn = DB_real_escape_string($ipn);
    $licensenum = DB_real_escape_string($licensenum);
    $juraddr = DB_real_escape_string($juraddr);
    $phisaddr = DB_real_escape_string($phisaddr);
    $phone = DB_real_escape_string($phone);
    $contrname = DB_real_escape_string($contrname);
...
function zb_AgentAssignStrictCreate($login, $agentid) {
    ...
    $clearLogin = DB_real_escape_string($login);
