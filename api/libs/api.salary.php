...
class Salary {
    ...
    public function createSalaryJob($taskid, $employeeid, $jobtypeid, $factor, $overprice, $notes) {
        ...
        $overprice = loginDB_real_escape_string($overprice);
        $date = curdatetime();
        $state = 0;
    ...
    public function employeeWageCreate($employeeid, $wage, $bounty, $worktime) {
        ...
        if (!isset($this->allWages[$employeeid])) {
            ...
            $wageF = loginDB_real_escape_string($wage);
            $bountyF = loginDB_real_escape_string($bounty);
    ...
    public function timesheetCreate() {
        ...
        if (wf_CheckPost(array('newtimesheet', 'newtimesheetdate', '_employeehours'))) {
            ...
            $dateF = loginDB_real_escape_string($_POST['newtimesheetdate']);
    ...
    function ltReportRenderResults() {
        ...
        if (wf_CheckPost(array('datefrom', 'dateto', 'jobtypeid'))) {
            $messages = new UbillingMessageHelper();
            $dateFrom = loginDB_real_escape_string($_POST['datefrom']) . ' 00:00:00';
            $dateTo = loginDB_real_escape_string($_POST['dateto']) . ' 23:59:59';
            $fromTimestamp = strtotime($dateFrom);
            $toTimestamp = strtotime($dateTo);
            $jobtypeId = loginDB_real_escape_string($_POST['jobtypeid']);
