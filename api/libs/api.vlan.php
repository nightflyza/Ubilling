...
function term_show_editform($term_id) {
        ...
        $inputs.= multinet_network_selector($termdata['netid']) . ' ' . __('NetID') . ' ' . wf_tag('br');
...
function terminators_show_form() {
        ...
        $inputs.= multinet_network_selector() . ' ' . __('NetID') . ' ' . wf_tag('br');
...
function show_all_terminators() {
        ...
        $tablecells .= wf_TableCell(__('Netid'));
        $tablecells .= wf_TableCell(__('Vlanpoolid'));
