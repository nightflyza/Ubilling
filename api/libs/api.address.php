...
function zb_AddressCreateCity($cityname, $cityalias) {
    $cityname = DB_real_escape_string($cityname);
...
function zb_AddressCreateStreet($cityid, $streetname, $streetalias) {
    $streetname = DB_real_escape_string($streetname);
...
function zb_AddressChangeStreetAlias($streetid, $streetalias) {
    ...
    $streetalias = DB_real_escape_string($streetalias);
...
function zb_AddressCreateBuild($streetid, $buildnum) {
    $buildnum = DB_real_escape_string($buildnum);
    $streetid = vf($streetid, 3);
...
function zb_AddressCreateApartment($buildid, $entrance, $floor, $apt) {
    $buildid = vf($buildid, 3);
    $entrance = DB_real_escape_string($entrance);
    $floor = DB_real_escape_string($floor);
    $apt = DB_real_escape_string($apt);
...
class BuildPassport {
    ...
    protected function savePassport() {
        if (wf_CheckPost(array('savebuildpassport'))) {
            ...
            $owner = DB_real_escape_string($_POST['powner']);
            $ownername = DB_real_escape_string($_POST['pownername']);
            $ownerphone = DB_real_escape_string($_POST['pownerphone']);
            $ownercontact = DB_real_escape_string($_POST['pownercontact']);
            $keys = (isset($_POST['pkeys'])) ? 1 : 0;
            $accessnotices = DB_real_escape_string($_POST['paccessnotices']);
            $floors = DB_real_escape_string($_POST['pfloors']);
            $entrances = DB_real_escape_string($_POST['pentrances']);
            $apts = DB_real_escape_string($_POST['papts']);
            $notes = DB_real_escape_string($_POST['pnotes']);
