...
function zb_UserContractDateCreate($contract, $date) {
    ...
    $date = DB_real_escape_string($date);
...
function zb_UserPassportDataCreate($login, $birthdate, $passportnum, $passportdate, $passportwho, $pcity, $pstreet, $pbuild, $papt) {
    ...
    $birthdate = DB_real_escape_string($birthdate);
    $passportnum = DB_real_escape_string($passportnum);
    $passportdate = DB_real_escape_string($passportdate);
    $passportwho = DB_real_escape_string($passportwho);
    $pcity = DB_real_escape_string($pcity);
    $pstreet = DB_real_escape_string($pstreet);
    $pbuild = DB_real_escape_string($pbuild);
    $papt = DB_real_escape_string($papt);
...
function zb_UserPassportDataChange($login, $birthdate, $passportnum, $passportdate, $passportwho, $pcity, $pstreet, $pbuild, $papt) {
    $exist_q = "SELECT `id` from `passportdata` WHERE `login`='" . DB_real_escape_string($login) . "'";
