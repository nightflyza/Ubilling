...
//$this->dbECMissedPayms->setDebug(true, true);
    ...
    public function extcontrasColorSettings() {
        ...
        $inputs .= wf_ColPicker(self::CTRL_ECCOLOR_FIVEDAYSTILLPAY_FRGND, __('5 days left till payday foreground'), $this->fiveDaysTillPayFRGND, false, '7', self::CTRL_ECCOLOR_FIVEDAYSTILLPAY_FRGND, 'background-color');
